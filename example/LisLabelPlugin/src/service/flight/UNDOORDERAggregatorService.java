...
/**
 * The Class UNDOORDERAggregatorService.
 *
 * @author esegato
 * @version $Revision$
 */
public class UNDOORDERAggregatorService implements IAggregatorService 
{
	 ...
	 */
	@Override
	public void aggregate(final IRawData arg0, final HeaderNode dataNode) {
	
		final String UNDO = arg0.getSafeString(FlightInputConstants.UNDOORDER);
		String data;
		...
		dataNode.addLine(FlightInputConstants.UNDOORDER, data)
			.setAttributeIf(!data.isEmpty(), EdmModelKeys.Attributes.LEFT_MOUSE_CALLBACK, leftMouseCallback);
	...
	public String getServiceName() {
		/** The service name. */
		String service_name = FlightInputConstants.UNDOORDER;
		return service_name;
	}
}
