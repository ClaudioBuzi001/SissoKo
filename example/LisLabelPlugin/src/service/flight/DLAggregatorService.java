...
public class DLAggregatorService implements IAggregatorService {
	...
	public void aggregate(final IRawData inputJson, final HeaderNode dataNode) {
		final String data = inputJson.getSafeString(FlightInputConstants.DLE);
		dataNode.addLine(FlightOutputConstants.DL, data);
    }
	...
	public String getServiceName() {
		/** The service name. */
		String m_serviceName = FlightOutputConstants.DL;
